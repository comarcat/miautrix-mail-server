...
> **Read blueprint Section 20 before building.** Two verification gates were not executed at
generation time. Version pins marked `UNVERIFIED` must be re-checked before install, and the
bundle has not been smoke-tested past the toolchain.
